	   ...
	   if(!$('.wrap').hasClass('iframe')){
	   		...
	   		switch(idx){
				...
				case 1 : openInterview(); return false;
	   			break;
	   			case 2 : winScTop = $('.dayWrap').offset().top;
	   			break;
	   			case 3 : winScTop = $('.galleryWrap').offset().top;
	   			break;
	   			case 4 : winScTop = $('.infoWrap').offset().top;
	   			break;
	   			case 5 : winScTop = $('.guestBookWrap').offset().top;
	   			break;
	   			case 6 : winScTop = $('.contactWrap').offset().top;
	   			break;
	   			case 7 : winScTop = $('.mindWrap').offset().top;
	   			break;
	   			case 8 : winScTop = $('.locationWrap').offset().top;
	   			break;
	   			case 9 : winScTop = $('.thanksWrap').offset().top;
	   			break;
	   		}
...
var DADIDAN = (function(){
  ...
  var posx;
  var posy;
    var pos_val1= 0, pos_val2= 0, pos_val3= 0, pos_val4= 0, pos_val5= 0,pos_val6= 0, pos_val7= 0,
       wH = $(window).height();
  ...
  myTimer = setTimeout(function() {
      randomPos();
        ...
        TweenMax.fromTo($('.leafOb').eq(i),10,{x:-50,rotation:-6*ranNum},{x:50,delay:0.2*i,rotation:6*ranNum,repeat: -1,yoyo: true,ease: Power2.easeInOut},{delay:220*i});
